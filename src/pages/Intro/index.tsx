...
export default function Intro() {
  ...
  const updatePadding = () => {
    if (imgRef.current) {
      setBtnSize({ horizontal: imgRef.current.offsetWidth * 0.066, vertical: imgRef.current.offsetWidth * 0.014 })
    }
  }
  ...
  return (
    <div className="flex flex-row justify-center">
      <div className="relative">
        ...
        />
        <Link
          className="absolute top-[9.5%] left-[4.5%] bg-slate-400 opacity-10 hover:opacity-10"
          to="/home"
          style={{
